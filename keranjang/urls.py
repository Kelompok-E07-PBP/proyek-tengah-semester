...
from . import views
from keranjang.views import keranjang_detail, tambah_ke_keranjang, hapus_dari_keranjang, update_keranjang, checkout, tambah_ke_keranjang_ajax, update_keranjang_ajax, hapus_dari_keranjang_ajax, show_json
...
urlpatterns = [
    ...
    path('json/', show_json, name='show_json_keranjang')
]