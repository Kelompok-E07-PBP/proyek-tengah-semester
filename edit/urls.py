...
from edit.views import delete_product_entry_flutter, update_product_entry_flutter
...
urlpatterns = [
    ...
    path('update-from-flutter/<str:id>', update_product_entry_flutter, name='update_from_flutter'),
]